...
function ProfilePanel({ user, onClose, onLogout, onViewChannel }) {
    ...
    <div className="panel-overlay" onClick={onClose} aria-modal="true" role="dialog">
      <div className="profile-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="profile-actions">
          <button id="profile-view-btn" className="profile-action-btn" onClick={() => { onViewChannel(); onClose(); }} aria-label="View your channel">
